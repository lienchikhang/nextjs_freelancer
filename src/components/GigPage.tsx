                    ...
                    <TabList className="tab__top">
                        {
                            ...
                            data[2]?.content.map((service: IService, idx: number) => {
                                return <Tab key={idx} className="top__item border-0 data-[selected]:!text-green-500 data-[selected]:!border-b-green-500 data-[selected]:!border-b-2">
